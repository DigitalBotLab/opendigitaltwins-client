    ...
    public class BuildingScenario
    {
        ...
        private async Task InitializeGraph()
        {
            ...
            await cl.CommandCreateDigitalTwin(new string[15]
                {
                    "CreateTwin", "dtmi:digitalbotlab:DigitalTwins:Space;1", "floor1",
            ...
            await cl.CommandCreateDigitalTwin(new string[15]
                {
                    "CreateTwin", "dtmi:digitalbotlab:DigitalTwins:Space;1", "room21",
            ...
            await cl.CommandCreateDigitalTwin(new string[18]
                {
                    "CreateTwin", "dtmi:digitalbotlab:DigitalTwins:Thermostat;1", "thermostat67",
